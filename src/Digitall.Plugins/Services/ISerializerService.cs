...
public interface ISerializerService
{
    ...
    /// <returns></returns>
    string JsonSerialize<T>(object data, DataContractJsonSerializerSettings settings = null);
    ...
    /// <returns></returns>
    T JsonDeserialize<T>(string json, DataContractJsonSerializerSettings settings = null, bool tidy = false);
}
