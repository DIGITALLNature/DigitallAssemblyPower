...
namespace Digitall.APower.Sharepoint.Contracts.SharePoint
{
    ...
    {
        [DataMember(Name = "value")] public List<File> Files { get; set; }
    }
    ...
    public class File
    {
        ...
        [DataMember(Name = "MajorVersion")] public int MajorVersion { get; set; }

        [DataMember(Name = "MinorVersion")] public string MinorVersion { get; set; }
        ...
        [DataMember(Name = "TimeCreated")] public DateTime TimeCreated { get; set; }
