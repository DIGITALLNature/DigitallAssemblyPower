...
namespace Digitall.APower.Sharepoint.Contracts.SharePoint
{
    ...
    public class BadRequestResponse : ISharepointPayload
    {
        ...
        [DataMember(Name = "error_codes")] public List<int> ErrorCodes { get; set; }

        [DataMember(Name = "timestamp")] public string Timestamp { get; set; }

        [DataMember(Name = "trace_id")] public string TraceId { get; set; }

        [DataMember(Name = "correlation_id")] public string CorrelationId { get; set; }
    }
}
