...
namespace Digitall.APower.Sharepoint.Contracts.SharePoint
{
    ...
    public class GroupResponse : ISharepointPayload
    {
        ...
        [DataMember(Name = "IsHiddenInUI")] public bool IsHiddenInUi { get; set; }

        [DataMember(Name = "LoginName")] public string LoginName { get; set; }

        [DataMember(Name = "Title")] public string Title { get; set; }

        [DataMember(Name = "PrincipalType")] public int PrincipalType { get; set; }
        ...
        [DataMember(Name = "OwnerTitle")] public string OwnerTitle { get; set; }
    }
}
